...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. After registration, sign in automatically
            ...
            <Card className="mx-auto w-full max-w-md shadow-lg border-0">
                ...
                <CardContent className="space-y-4">
                    ...
                    >
                        ...
                        <span className="flex-1 text-center font-medium">Sign up with Google</span>
                    </Button>

                    <p className="px-8 text-center text-sm text-slate-500 mt-6">
                        Already have an account?{" "}
                        <Link href="/login" className="underline underline-offset-4 hover:text-blue-600 font-medium">
                            Log in
                        </Link>
                    </p>
                </CardContent>
